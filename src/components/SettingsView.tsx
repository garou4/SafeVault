    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          <ShieldCheck className="w-7 h-7 text-emerald-600" /> Vault Security Settings
        </h2>
        <p className="text-sm text-slate-500 mt-1">
          Manage how your encrypted folders behave for maximum privacy.
        </p>
      </div>
      ...
      <div className="bg-slate-900 text-slate-200 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-4 border border-slate-800 shadow-md">
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400">
            Files and folders are stored safely in browser storage.
          </p>
        </div>
        ...
        >
          <RefreshCw className="w-3.5 h-3.5 text-red-400" /> Reset All Vault Data
        </Button>
      </div>
    </div>
  );
